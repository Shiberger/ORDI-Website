...
export function SmoothScroll({ children }: Props) {
  ...
  useGSAP(
    () => {
      ...
      // Site-wide scroll reveal — any element with [data-reveal] fades and
      // rises 28px into place when it enters the viewport. once:true keeps it
      // a one-shot reveal (no repeat on scroll-back).
      if (reduced) {
